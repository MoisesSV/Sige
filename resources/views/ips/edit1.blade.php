                        ...
                        <!--Aparto para que le usuario selecione los datos del equipo (Numero de serie, Tipo de equipo, MAC)
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3 pl-0">
                                    <br>
                                        ...
                                        <label  id="tipo" name="tipo" class="form-control" placeholder="Disabled input">{{$edit->tipo_equipo}}</label>
                                    </div>
                                    <div class="col-md-3 pl-0">
                                    <br>
                                        <!--UDG ID.-->
                                        <label class="font-weight-bold" for="subred">UDG ID:</label>
                                        <label  id="udg_id" name="udg_id" class="form-control" placeholder="Disabled input">{{$edit->udg_id}}</label>
                                    </div>
                                    <div class="col-md-6 pl-0">
                                        <br>
                                        <!--Usuario Responsable del Equipo.-->
                                        <label class="font-weight-bold" for="subred">Responsable del Equipo:</label>
                                        <label id="usuario" name="usuario" class="form-control" placeholder="Disabled input" value="">{{$edit->nombre}} </label>
                                    </div>
                                    <div class="col-md-12">
                                        <br>
                                        <!--Ubicacion Fisica del Equipo.-->
                                        <label class="font-weight-bold" for="subred">Ubicación del Equipo:</label>
                                        <textarea style="background-color: #fcfcfc; rows="2.5" id="area" name="area" class="form-control" placeholder="Disabled input">{{$edit->area}}</textarea>
                                    </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-success"> Guardar<i class="ml-1 fas fa-save"></i></button>
